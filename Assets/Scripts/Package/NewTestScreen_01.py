...
class NewTestScreen_01(ctk.CTkFrame):  # class for the NewTestScreen window
    ...
    def create_widgets(self):
        ...
        # button frame------------------------------------------------------------
        newtestscreen01_button_frame = ctk.CTkFrame(master=self,  # frame for the buttons and the menu
                                                    width=340,
                                                    height=360)
        ...
        # first name entry------------------------------------------------------------
        newtestscreen01_first_name_entry_label = ctk.CTkLabel(master=newtestscreen01_button_frame,
                                                              fg_color=color_SET,
                                                              width=100,
                                                              height=40,
                                                              corner_radius=10,
        ...
        newtestscreen01_first_name_entry = ctk.CTkEntry(master=newtestscreen01_button_frame,
        ...
        # last name entry------------------------------------------------------------
        newtestscreen01_last_name_entry_label = ctk.CTkLabel(master=newtestscreen01_button_frame,
                                                             fg_color=color_SET,
                                                             width=100,
                                                             height=40,
                                                             corner_radius=10,
        ...
        newtestscreen01_last_name_entry = ctk.CTkEntry(master=newtestscreen01_button_frame,
        ...
        # birth date entry------------------------------------------------------------
        newtestscreen01_birth_date_entry_label = ctk.CTkLabel(master=newtestscreen01_button_frame,
                                                              fg_color=color_SET,
                                                              width=100,
                                                              height=40,
                                                              corner_radius=10,
        ...
        newtestscreen01_birth_date_entry = ctk.CTkEntry(master=newtestscreen01_button_frame,
